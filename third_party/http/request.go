...
func (r *Request) write(w io.Writer, usingProxy bool, extraHeaders Header, waitForContinue func() bool) (err error) {
	...
	if stringContainsCTLByte(ruri) {
		return errors.New("nebula/third_party/http: can't write control character in Request.URL")
	}
	...
	// Header lines
	if !r.Header.has("Host") && !r.Header.has("host") {
...
func NewRequestWithContext(ctx context.Context, method, url string, body io.Reader) (*Request, error) {
	...
	if !validMethod(method) {
		return nil, fmt.Errorf("nebula/third_party/http: invalid method %q", method)
	}
	if ctx == nil {
		return nil, errors.New("nebula/third_party/http: nil Context")
	}
