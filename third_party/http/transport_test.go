...
import (
	...
	"nebula/third_party/http/internal"
	"nebula/third_party/http/internal/nettrace"
	"net"
	"net/textproto"
	"net/url"
	"os"
...
func TestTransportCancelRequestInDial(t *testing.T) {
	...
	want := `dial: blocking
canceling
Get = Get "http://something.no-network.tld/": nebula/third_party/http: request canceled while waiting for connection
`
	if got != want {
		t.Errorf("Got events:\n%s\nWant:\n%s", got, want)
	}
