...
//	import _ "nebula/third_party/http/pprof"
//
// If your application is not already running an http server, you
// need to start one. Add "nebula/third_party/http" and "log" to your imports and
...
import (
	...
	"nebula/third_party/http/internal/profile"
	"net/url"
	"os"
	"runtime"
	"runtime/pprof"
