...
func TestUTLSFingerprintClientHelloKeepPSK(t *testing.T) {
	...
	// 						Supported Groups: Reserved (GREASE) (0xdada)
	// 						Supported Groups: x25519 (0x001d)
	// 						Supported Groups: secp256r1 (0x0017)
	// 						Supported Groups: secp384r1 (0x0018)
	...
	// 						Key Share Entry: Groups: Reserved (GREASE), Key Exchange length: 1
	// 								Groups: Reserved (GREASE) (56026)
	// 								Key Exchange Length: 1
	// 								Key Exchange: 00
	// 						Key Share Entry: Groups: x25519, Key Exchange length: 32
	// 								Groups: x25519 (29)
