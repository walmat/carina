...
func (f *Fingerprinter) FingerprintClientHello(data []byte) (*ClientHelloSpec, error) {
	...
	for !extensions.Empty() {
		...
		case extensionCompressCertificate:
			// TODO: get supported algorithms instead of hardcoding brotli, cba to rn
			clientHelloSpec.Extensions = append(clientHelloSpec.Extensions, &CompressCertificateExtension{Algorithms: []CertCompressionAlgo{CertCompressionBrotli}})
